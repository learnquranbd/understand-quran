                                    ...
                                    <div class="alert alert-success">
                                       ...
                                       <pre id="totalfound"></pre>
										...
										<div class="control-group">
											<label class="control-label" for="surah">Select Surah </label>
											<div class="controls">
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="ayah">Select Ayah </label>
											<div class="controls">
												<select name="ayah" id="ayah">
...
/*
            ...
            function recursively_ajax()
            {
					    ...
					    $.ajax({
                            ...
                            url: 'process_ayah_grammer.php', 
                            data: { surah: csura_ayah[0], ayah: csura_ayah[1], task : 2},
